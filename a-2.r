...
free_throw_attempts_per_game= free_throws_attempts / Games


free_throw_accuracy = free_throws / free_throws_attempts


matplot(t(free_throw_attempts_per_game), type = "b", pch = 1:10, col = 1:10, xlab = "Seasons", ylab = "Free Throw Attempts per Game", main = "Free Throw Attempts per Game")
legend("topright", inset = 0.01, legend = rownames(free_throws_attempts), col = 1:10, pch = 1:10, title = "Players")


matplot(t(free_throw_accuracy), type = "b", pch = 1:10, col = 1:10, xlab = "Seasons", ylab = "Free Throw Accuracy", main = "Free Throw Accuracy")
legend("topright", inset = 0.01, legend = rownames(free_throws), col = 1:10, pch = 1:10, title = "Players")